...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label lblDescription 
      Caption         =   "使用vb制作的模仿Microsoft画图软件         版本特性：原基础上窗体更新"
      ForeColor       =   &H00000000&
      Height          =   1170
      Left            =   1050
      TabIndex        =   3
   ...
   Begin VB.Label lblTitle 
      Caption         =   "VisualBaic6.0 Paint by Morgan"
      ForeColor       =   &H00000000&
      Height          =   480
      Left            =   1050
      TabIndex        =   5
   ...
   Begin VB.Label lblVersion 
      Caption         =   "v4.7.0   Copyright (c) 2022"
      Height          =   225
      Left            =   1050
      TabIndex        =   6
      Top             =   780
...
Private Sub Form_Load()
    ...
    lblVersion.Caption = "版本 " & ":" & "v4.7.0"
    lblTitle.Caption = "VisualBaic6.0 Paint by Morgan"
End Sub
